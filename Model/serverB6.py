...
from /home/richard/YPN/B5/serverB5YJ.py
"""
import os
import zmq
import six
...
# BATCH_SIZE, STEPS, EPOCHS = 1, 1, 3    # Run Time: 00:03:36
...
if __name__ == "__main__":
  ...
  #all_yuvs = ['/home/richard/dataB6/'+i+'/yuv.h5' for i in all_dirs]
  #print('#--- all_yuvs =', all_yuvs)
  #random.seed(0) # makes the random numbers predictable
  #random.shuffle(all_yuvs)
  all_yuvs = ['/home/richard/dataB6/UHD--2018-08-02--08-34-47--37/yuv.h5',
